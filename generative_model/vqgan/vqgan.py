...
Training, losses, datasets, checkpoints, and visualization live in general_utils/utils/.
"""
...
def main():
    ...
    from general_utils.utils.trainers import VQGANTrainConfig, VQGANTrainer
