...
from generative_model.noob.ddpm.ddpm import DDPM
from generative_model.noob.ddpm.datasets import get_img_shape,get_dataloader
from generative_model.noob.ddpm.model import (build_network,convnet_big_cfg,convnet_medium_cfg,convnet_small_cfg,unet_1_cfg,unet_res_cfg)
import cv2
import numpy as np
import einops
...
if __name__ =='__main__':
    ...
    config_id=4
    device='cuda'
    model_path='generative_model/noob/ddpm/model_unet_res.pth'
